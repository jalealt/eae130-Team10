...
# --- Feasible Region Between Comparable Turn and Governing ---

comp_turn = comp_curves[1]        # Turn constraint (dashed)
comp_gov  = comp_curves[6]        # Governing constraint (dashed)

plt.fill_between(
    S_grid,
    comp_turn,
    comp_gov,
    where=(comp_gov > comp_turn),
    color="grey",
    alpha=0.35,
    label="Feasible Region (Comparable)"
)
...
plt.title("Converged T vs. S for F/A-18E/F")
