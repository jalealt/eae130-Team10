...
# Fuel Fraction
L_D_max = 11              # F15 Comparable Aircraft
L_D = 0.94 * L_D_max
c = 0.88
V = 835
...
# Empty Weight
def calculate_empty_weight(S_wing, S_ht, S_vt, S_wet_fuselage, TOGW, T_total, num_engines):
    W_wing = S_wing * 9
    W_ht = S_ht * 4
    W_vt = S_vt * 5.3
    ...
    Engine_weight = calculate_engine_weight(T_total)
    W_engines = Engine_weight * 1.3
