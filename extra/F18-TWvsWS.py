...
S_ref = 400 # ft^2 #CHANGE
S_wet = 2200 # ft^2 #CHANGE
...
v_wod_launch = 0
v_cat_launch = 175 * 1.688 # ft/s # Roskam, Part I, Eqn 3.10
v_wod_recovery = 15 * 1.688 # ft/s # RFP
v_turn = 1.5*v_stall # ft/s
turn_rate = 10 / 57.3 # rad/s
g = 32.17 # ft/s^2
...
plt.title('T/W vs. W/S for F/A 18 E/F')
...
plt.plot(132, 0.67, label = 'F/A 18 E/F', marker = 'o')
